export const JOIN_USER_TO_ROOM = 'join_user_to_room';
export const YOU_JOINED_ROOM = 'you_joined_room';
export const USER_JOINED_ROOM = 'user_joined_room';
export const YOU_RECONNECTED_TO_ROOM = 'you_reconnected_to_room';
export const USER_RECONNECTED_TO_ROOM = 'user_reconnected_to_room';
export const ERROR_OF_JOINING_USER_TO_ROOM = 'error_of_joining_user_to_room';

export const LEAVE_USER_FROM_ROOM = 'leave_user_from_room';
export const YOU_LEFT_ROOM = 'you_left_room';
